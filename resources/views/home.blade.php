                            ...
                            <div class="d-flex justify-content-between">
                                <div class="split-header">
                                    <img class="img-ss mt-1 mb-1 mr-2"
                                        src="{{ asset('data-asset') }}/images/social-icons/instagram.svg" alt="instagram">
                        ...
                        <table class="table table-hover table-sm">
                            ...
                            <tbody>
                                <tr>
                                    <td class="pr-0 pl-4">
                                        <img class="profile-img img-sm"
                                            src="{{ asset('data-asset') }}/images/profile/male/image_4.png"
                                            alt="profile image">
                                    </td>
                                    <td class="pl-md-0">
                                ...
                                <tr>
                                    <td class="pr-0 pl-4">
                                        <img class="profile-img img-sm"
                                            src="{{ asset('data-asset') }}/images/profile/male/image_10.png"
                                            alt="profile image">
                                    </td>
                                    <td class="pl-md-0">
                            ...
                            <div class="timeline-vertical dashboard-timeline">
                                ...
                                <div class="activity-log">
                                    ...
                                    <div class="log-details">Report has been updated <div class="grouped-images mt-2">
                                            ...
                                            <img class="img-sm"
                                                src="{{ asset('data-asset') }}/images/profile/male/image_5.png"
                                                alt="Profile Image" data-toggle="tooltip" title="Edward Wilson">
                                            <img class="img-sm"
                                                src="{{ asset('data-asset') }}/images/profile/female/image_6.png"
                                                alt="Profile Image" data-toggle="tooltip" title="Billy Williams">
                                            <img class="img-sm"
                                                src="{{ asset('data-asset') }}/images/profile/male/image_6.png"
